...
public class WxpayUtil {
    ...
    public static String generateSignedXml(final Map<String, String> data, String key) {
        return generateSignedXml(data, key, WxpayConsts.SignType.MD5);
    }
     ...
     * @return 含有sign字段的XML
     */
    public static String generateSignedXml(final Map<String, String> data, String key, WxpayConsts.SignType signType) {
    ...
    public static boolean isSignatureValid(Map<String, String> data, String key) {
        return isSignatureValid(data, key, WxpayConsts.SignType.MD5);
    }
     ...
     * @return 签名是否正确
     */
    public static boolean isSignatureValid(Map<String, String> data, String key, WxpayConsts.SignType signType) {
        if (!data.containsKey(WxpayConsts.FIELD_SIGN)) {
            return false;
        }
        String sign = data.get(WxpayConsts.FIELD_SIGN);
    ...
    public static String generateSignature(final Map<String, String> data, String key) {
        return generateSignature(data, key, WxpayConsts.SignType.MD5);
    }
     ...
     * @return 签名
     */
    public static String generateSignature(final Map<String, String> data, String key, WxpayConsts.SignType signType) {
        ...
        if (WxpayConsts.SignType.MD5.equals(signType)) {
            return toMd5(sb.toString()).toUpperCase();
        } else if (WxpayConsts.SignType.HMACSHA256.equals(signType)) {
